...
public class PopularAdapters extends RecyclerView.Adapter<PopularAdapters.ViewHolders> {
    ...
    public ViewHolders onCreateViewHolder(@NonNull ViewGroup parent, int  viewType) {
        return new ViewHolders(LayoutInflater.from(parent.getContext()).inflate(R.layout.popular_item,parent,false));
    }
